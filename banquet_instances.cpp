...
constexpr banquet_aes_t AES128_PARAMS = {16, 16, 1, 200, 9  /* 160 + 40 */};
constexpr banquet_aes_t AES192_PARAMS = {24, 16, 2, 416, 10 /* 2*192 + 32 */};
constexpr banquet_aes_t AES256_PARAMS = {32, 16, 2, 500, 10 /* 2*224 + 52 */};

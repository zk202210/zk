...
fn test_ringsig_fold_circuit<T: Field>() {
    use rustzk::gkr;
...
fn zk_ringsig_fold_w_vpd<T: Field>(log_ring_size: usize) {
    let path_size = log_ring_size + 1;
    let log_num_hash = ceil_log(path_size);
    stats_reset_all();
    ...
    let mut lc = LocalVithChannel::<T>::new(&mseed, tape_len, 32, N_PARTY);
...
fn test_zk_ringsig_fold<T: Field>() {
...
#[test]
fn test_zk_ringsig_fold_all() {
    println!("");
    // test_ringsig_fold_circuit::<GF2p16>();
    // test_zk_ringsig_fold::<GF2p16>();
    // test_zk_ringsig_fold::<GF2p32>();
    // test_zk_ringsig_fold::<GF2p64>();
    // test_zk_ringsig_fold::<GF2p128>();
    test_zk_ringsig_fold::<GF2p192>();
    // test_zk_ringsig_fold::<GF2p256>();
}
